...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(_ term: String, offset: Int?, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
        return searchWithTerm(term, offset: offset, sort: nil, categories: nil, distance: nil, deals: nil, completion: completion)
    }
    
    func searchWithTerm(_ term: String, offset: Int?, sort: YelpSortMode?, categories: [String]?, distance: Float?, deals: Bool?, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
